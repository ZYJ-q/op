...
impl TradeMapper {
  ...
  pub fn insert_trade(trades:Vec<Value>) -> bool {
    ...
    let flag = conn.exec_batch(
      r"INSERT IGNORE INTO trate_histories (th_id, tra_symbol, tra_order_id, tra_commision, tra_time, is_maker, position_side, price, qty, quote_qty, realized_pnl, side)
